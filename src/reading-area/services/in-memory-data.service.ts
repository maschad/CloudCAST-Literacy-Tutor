...
export class InMemoryDataService implements InMemoryDbService {
    createDb(): {} {
        let onScreenSentences = [
            ...
            {id: 2, text: 'I went to the park today and it was very exciting', highestScore: 9},
            {id: 3, text: 'My favorite color is blue', highestScore: 7},
            {id: 4, text: 'Bob Marley was born in Saint Ann but grew up in Trench Town', highestScore: 0},
            ...
            {id: 8, text: 'Marcus Garvey is my favorite national hero', highestScore: 10}
        ];
